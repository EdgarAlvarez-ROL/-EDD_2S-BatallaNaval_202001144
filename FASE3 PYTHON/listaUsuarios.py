...
class Usuario:
    def __init__(self, ids, nick, password, monedas, edad):
        self.ids = ids
        self.nick = nick
...
# nuevalista.insertar_final(Usuario("1","ROL","1234","44","21"))
# nuevalista.insertar_final(Usuario("2","PEPE","SAFD","ASDF","ASDF"))
# nuevalista.insertar_final(Usuario("3","OSCAR","12","12","22"))
# nuevalista.imprimir()
